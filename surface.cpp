...
cube::cube(RGB new_color, vector3 new_center, float new_edge_length, vector3 new_up, vector3 new_right, vector3 new_forward) {
	color			= new_color;
	center		= new_center;
...
void cube::set(RGB new_color, vector3 new_center, float new_edge_length, vector3 new_up, vector3 new_right, vector3 new_forward) {
	color			= new_color;
	center		= new_center;
	edge_length	= new_edge_length;
	up				= new_up / length(new_up);
...
bool triangle::hit(Ray incoming, Interval where, surface& what, hit_info& info) {
	...
	float ak_minus_jb	= ((a.get(0) - b.get(0)) * (a.get(1) - o.get(1))) - ((a.get(0) - o.get(0)) * (a.get(1) - b.get(1)));
	float jc_minus_al	= ((a.get(0) - o.get(0)) * (a.get(2) - b.get(2))) - ((a.get(0) - b.get(0)) * (a.get(2) - o.get(2)));
	float bl_minus_kc	= ((a.get(1) - b.get(1)) * (a.get(2) - o.get(2))) - ((a.get(1) - o.get(1)) * (a.get(2) - b.get(2)));
	
	float M		=	((a.get(0) - b.get(0)) * ei_minus_hf) +
						((a.get(1) - b.get(1)) * gf_minus_di) +
						((a.get(2) - b.get(2)) * dh_minus_eg);
	float beta	=	(((a.get(0) - o.get(0)) * ei_minus_hf) +
						 ((a.get(1) - o.get(1)) * gf_minus_di) +
						 ((a.get(2) - o.get(2)) * dh_minus_eg)) /
						M;
	float gamma	=	((d.get(2) * ak_minus_jb) +
						 (d.get(1) * jc_minus_al) +
						 (d.get(0) * bl_minus_kc)) /
						M;
	float t		=	(((a.get(2) - c.get(2)) * ak_minus_jb) +
						 ((a.get(1) - c.get(1)) * jc_minus_al) +
